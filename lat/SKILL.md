...
Grilling 時與使用者共同討論。Spec 確認後，在已確認的需求、範圍與驗收條件內，自動完成拆票、實作、測試、審查、修正與交付。未回覆不視為同意；Orchestrator 僅能在既有授權內裁決。既有授權內的工作直接推進；為其徵詢許可與越權裁決同樣偏離流程。改變已確認需求或超出授權的事項，先保留待確認，其他不受影響的工作可繼續。
